  ...
  return (
    <div className="space-y-6 lg:space-y-10 animate-in-up">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6 lg:gap-8">
          <div className="space-y-4 text-center md:text-left">
            ...
            <p className="text-muted-foreground text-base lg:text-lg max-w-xl font-body">
              Your library is seeing a <span className="text-white font-bold">15% increase</span> in engagement this week.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        <Card className="lg:col-span-2 glass-card border-none rounded-[24px] lg:rounded-[32px] p-2">
          <CardHeader className="p-4 lg:p-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <CardTitle className="text-xl lg:text-2xl font-headline font-bold text-white">Engagement Flow</CardTitle>
                <p className="text-xs lg:text-sm text-white/40 font-medium font-body">Monthly lending trends</p>
              </div>
              <Button onClick={() => router.push('/dashboard/reports')} variant="outline" size="sm" className="bg-white/5 border-white/10 rounded-xl text-[10px] lg:text-xs font-headline font-semibold">
                VIEW FULL REPORT <ArrowUpRight className="ml-2 w-3 h-3" />
              </Button>
            </div>
          </CardHeader>
          <CardContent className="h-[250px] lg:h-[350px] p-2 lg:p-6 pt-0 font-body">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={borrowingData}>
                ...
                <XAxis 
                  ...
                  axisLine={false} 
                  tickLine={false} 
                  tick={{fill: 'rgba(255,255,255,0.4)', fontSize: 10, fontWeight: 600, fontFamily: 'Manrope'}} 
                  dy={10}
                />
                <YAxis 
                  axisLine={false} 
        ...
        <Card className="glass-card border-none rounded-[24px] lg:rounded-[32px] p-2">
          <CardHeader className="p-4 lg:p-8">
            <CardTitle className="text-xl lg:text-2xl font-headline font-bold text-white">Activity Log</CardTitle>
            <p className="text-xs lg:text-sm text-white/40 font-medium font-body">Recent events</p>
          </CardHeader>
          <CardContent className="p-4 lg:p-6 pt-0 space-y-4 lg:space-y-6">
            ...
            <Button onClick={() => router.push('/dashboard/transactions')} variant="ghost" className="w-full text-[10px] font-headline font-semibold tracking-widest text-primary hover:bg-primary/10 rounded-xl mt-2 lg:mt-4">
